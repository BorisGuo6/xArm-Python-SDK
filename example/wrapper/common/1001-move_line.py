...
arm.set_position(x=300, y=0, z=350, roll=-180, pitch=0, yaw=0, speed=100, wait=True)
print(arm.get_position(), arm.get_position(is_radian=True))
arm.set_position(x=300, y=200, z=350, roll=-180, pitch=0, yaw=0, speed=200, wait=True)
print(arm.get_position(), arm.get_position(is_radian=True))
arm.set_position(x=500, y=200, z=350, roll=-180, pitch=0, yaw=0, speed=300, wait=True)
print(arm.get_position(), arm.get_position(is_radian=True))
arm.set_position(x=500, y=-200, z=350, roll=-180, pitch=0, yaw=0, speed=400, wait=True)
print(arm.get_position(), arm.get_position(is_radian=True))
arm.set_position(x=300, y=-200, z=350, roll=-180, pitch=0, yaw=0, speed=500, wait=True)
print(arm.get_position(), arm.get_position(is_radian=True))
arm.set_position(x=300, y=0, z=350, roll=-180, pitch=0, yaw=0, speed=600, wait=True)
print(arm.get_position(), arm.get_position(is_radian=True))
