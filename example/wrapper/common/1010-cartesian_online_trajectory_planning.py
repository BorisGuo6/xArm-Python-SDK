...
arm.set_position(x=400, y=-50, z=350, roll=-180, pitch=0, yaw=0, speed=100, is_radian=False, wait=True)
...
for i in range(10):
    ...
    arm.set_position(x=400, y=-150, z=350, roll=-180, pitch=0, yaw=0, speed=speed, wait=False)
    time.sleep(1)
    # the running command will be interrupted, and run the new command
    arm.set_position(x=400, y=100, z=350, roll=-180, pitch=0, yaw=0, speed=speed, wait=False)
    time.sleep(1)
